		...
		else
		{
			...
			else
			{
				...
				else
				{
					...
					$sql2 = mysql_query("SELECT * FROM customer WHERE Username = '$_POST[user_name]' AND Password = '$_POST[user_pass]'");
					...
					header('location:http://localhost/wisata/php/forum/index.php');
